...
const CrearUsuario = () => {
    ...
    return (
        <MenuLateral>
            <form className="crear-usuario h-full gap-2 min-w-[0px]" onSubmit={form.handleSubmit(onSubmit)}>
                <div className='crear-usuario__tittle flex justify-center items-center py-3 border-b-[1px] mx-10'>
                    <h1 className='text-2xl font-semibold text-blue-500'>CREAR USUARIO</h1>
                </div>
